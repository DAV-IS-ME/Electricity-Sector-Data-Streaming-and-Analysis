...
* Subscribes to the designated group topic, decodes incoming JSON text payloads, and securely updates an in-memory live dataset utilizing thread locks for safe concurrent read/writes.
